...
# SemaphoreVerifierKeyPts Contract Soroban migration
...
use soroban_sdk::{ contract, contracterror, contractimpl, symbol_short, BytesN, Env, Vec };
...
mod test {
    ...
    fn test_check_invariant() {
        ...
        assert_eq!(client.try_check_invariant(&2), Err(Ok(Error::VKPtBytesMaxDepthInvariantViolated)));
        
        assert_eq!(client.try_check_invariant(&0), Err(Ok(Error::VKPtBytesMaxDepthInvariantViolated)));
    }
